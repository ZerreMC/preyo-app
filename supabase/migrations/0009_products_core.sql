-- Catálogo de productos del usuario (manual + referencia OFF).
...
-- Índice único parcial: dos productos no pueden compartir barcode
...
-- SELECT: todos los autenticados leen el catálogo (conocimiento compartido)
CREATE POLICY products_select ON public.products
    FOR SELECT TO authenticated USING (true);

-- INSERT: el usuario solo puede crear productos propios
